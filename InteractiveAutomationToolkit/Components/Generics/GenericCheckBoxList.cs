namespace Skyline.DataMiner.Utils.InteractiveAutomationScript
{
	...
	public class CheckBoxList<T> : CheckBoxListBase, ICheckBoxList<T>
	{
		...
		public bool ContainsOption(Option<T> option)
		{
			...
			return checkBoxListOptions.Contains(option);
		}

		/// <inheritdoc/>
		public bool ContainsOption(T value)
		{
			return checkBoxListOptions.Any(x => Object.Equals(x.Value, value));
		}
		...
		protected internal override void RaiseResultEvents(ILogger logger = null)
		{
			...
			{
				logger?.Debug(nameof(DropDown), nameof(RaiseResultEvents), $"OnChange; Option {change.Option.DisplayValue} changed to {change.IsChecked}");
