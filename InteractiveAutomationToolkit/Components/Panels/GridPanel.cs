namespace Skyline.DataMiner.Utils.InteractiveAutomationScript
{
	...
	public class GridPanel : Panel, IGridPanel
	{
		...
		[Obsolete("This method is only here for backward compatibility", false)]
		public IEnumerable<WidgetLocationPair> GetAllWidgetLocationPairs()
		{
			foreach (KeyValuePair<IWidget, WidgetLocation> pair in widgetLocations)
			{
				yield return new WidgetLocationPair(pair.Key, pair.Value);
			}
