...
namespace InteractiveAutomationToolkitTests
{
	...
	public class GenericDropDownTests
	{
		...
		public void HandleChange_Test1()
		{
			...
			// User selects 2
			var option2 = dropdown.Options.Single(x => x.Value == 2);

			var mockedUiResults = new Mock<IUIResults>();
			mockedUiResults.Setup(x => x.GetString(It.IsAny<string>())).Returns(dropdown.GetRawValue(option2));
		...
		public void HandleChange_Test2()
		{
			...
			var mockedUiResults = new Mock<IUIResults>();
			mockedUiResults.Setup(x => x.GetString(It.IsAny<string>())).Returns(dropdown.GetRawValue(option1));
